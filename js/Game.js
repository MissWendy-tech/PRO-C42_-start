class Game {
  constructor() {
    ...
    //Para alejar los obstaculoas tan pronto como choquen
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //guardamos el valor de player.life en la variable currenlife
        ...
        if (index === player.index) {
          ...
          //funciones de collision
            ...
            //En funcion de blast activamos los controles
  ...
  handlePlayerControls() {
    //Nos aseguramos que los controles se muevan solo si blast es false
      ...
      if (keyIsDown(LEFT_ARROW) && player.positionX > width / 3 - 50) {
        //para rebotar los autos del obstaculo
  ...
  // Creamos la funcion para colicionar con los obstaculos
      
  
  
  //para alejar el auto de los obstaculos despues de una colision
  
      
//Comprobando que auto esta colisionando
